...
dir_img_test = Path('/home/group-segmentation/SPADE/results/lc_crop256_bs16_ncopy50_epochs10_extra_bd/test_200imgs/test_latest/images/real_image_tif')
dir_syn_test = Path('/home/group-segmentation/SPADE/results/lc_crop256_bs16_ncopy50_epochs10_extra_bd/test_200imgs/test_latest/images/synthesized_image_tif')
dir_mask = Path('/home/group-segmentation/SPADE/results/lc_crop256_bs16_ncopy50_epochs10_extra_bd/test_200imgs/test_latest/images/input_extra_label_uncolor')
dir_mask_syn_test = Path('/home/group-segmentation/SPADE/results/lc_crop256_bs16_ncopy50_epochs10_extra_bd/test_200imgs/test_latest/images/input_extra_label_uncolor')
...
def get_args():
    ...
    parser.add_argument('--models', '-m', nargs='+', metavar='FILE', default = ["checkpoints/syn_000/checkpoint_epoch5_mix_0.pth", "checkpoints/syn_025/checkpoint_epoch5_mix_25.pth", "checkpoints/syn_050/checkpoint_epoch5_mix_50.pth", "checkpoints/syn_075/checkpoint_epoch5_mix_75.pth", "checkpoints/syn_100/checkpoint_epoch5_mix_100.pth", "checkpoints/syn_200/checkpoint_epoch5_mix_100.pth"],
    ...
    parser.add_argument('--label_nc', '-nc', type=int, default=1,
                        help='Number of labels: 6 for lc, 1 for bd')

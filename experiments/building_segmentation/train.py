...
dir_img = Path('/home/group-segmentation/SPADE/results/lc_crop256_bs16_ncopy50_epochs10_extra_bd/train_1000imgs/train_latest/images/real_image_tif')
dir_syn = Path('/home/group-segmentation/SPADE/results/lc_crop256_bs16_ncopy50_epochs10_extra_bd/train_1000imgs/train_latest/images/synthesized_image_tif')
dir_mask = Path('/home/group-segmentation/SPADE/results/lc_crop256_bs16_ncopy50_epochs10_extra_bd/train_1000imgs/train_latest/images/input_extra_label_uncolor')
dir_mask_syn = Path('/home/group-segmentation/SPADE/results/lc_crop256_bs16_ncopy50_epochs10_extra_bd/train_1000imgs/train_latest/images/input_extra_label_uncolor')
...
def get_args():
    ...
    parser.add_argument('--contain_dontcare_label', type=bool, default=False, help='if the label map contains dontcare label (dontcare=opt.dontcare)')

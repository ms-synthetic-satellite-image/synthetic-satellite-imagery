...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='lc_crop256_bs16_ncopy50_epochs10', help='name of the experiment. It decides where to store samples and models')
        ...
        parser.add_argument('--preprocess_mode', type=str, default='crop', help='scaling and cropping of images at load time.', choices=("resize_and_crop", "crop", "scale_width", "scale_width_and_crop", "scale_shortside", "scale_shortside_and_crop", "fixed", "none", "crop_only"))
        ...
        parser.add_argument('--contain_dontcare_label', action='store_true', help='if the label map contains dontcare label (dontcare=opt.dontcare)')
        parser.add_argument('--dontcare', type=int, default=13, help='dontcare label value)')
        ...
        # for custum dataset
        parser.add_argument('--label', type=str, default='lc', help='label type: land_cover (lc), building (bd) or combined both (lc_bd) ')
